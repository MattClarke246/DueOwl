...
export function WaterfallPipeline() {
  return (
    <section id="how" className="relative scroll-mt-24">
      {/* MOBILE-ONLY: rocky cliff band — warm rock walls flanking a
          cascading water strip down the middle. Top color blends with
          CreekPool's deep-meadow edge; bottom blends with SettlingPool's
          pale-water top. */}
      <div
        aria-hidden
      ...
      />
      {/* Cliff face texture — two warm rock columns on left/right */}
      <div
        aria-hidden
        className="md:hidden pointer-events-none absolute inset-y-0 left-0 w-[28%] -z-10 opacity-70"
        style={{
          background:
      ...
      <div
        aria-hidden
        className="md:hidden pointer-events-none absolute inset-y-0 right-0 w-[28%] -z-10 opacity-70"
        style={{
          background:
            "linear-gradient(270deg, rgba(91,59,38,0.55) 0%, rgba(142,94,62,0.35) 60%, transparent 100%)",
        }}
      />
      {/* Cascading water strip down the centre (mobile only).
          Uses the waterfallCascade keyframe defined in globals.css. */}
      <div
        aria-hidden
        className="md:hidden pointer-events-none absolute inset-y-0 left-1/2 -translate-x-1/2 w-[42%] -z-10 opacity-85"
        style={{
          background:
            "linear-gradient(180deg, rgba(234,246,253,0.0) 0%, rgba(159,211,240,0.7) 6%, rgba(93,173,226,0.75) 35%, rgba(63,160,220,0.7) 65%, rgba(159,211,240,0.6) 92%, rgba(234,246,253,0) 100%), repeating-linear-gradient(180deg, rgba(255,255,255,0.18) 0px, rgba(255,255,255,0.18) 2px, transparent 2px, transparent 8px)",
      ...
      />
      {/* Mist puffs at top and bottom of the falls */}
      <div
        aria-hidden
        className="md:hidden pointer-events-none absolute inset-x-0 top-[6%] h-16 -z-10 opacity-55"
        style={{
          background:
      ...
      <div
        aria-hidden
        className="md:hidden pointer-events-none absolute inset-x-0 bottom-[4%] h-20 -z-10 opacity-70"
        style={{
          background:
