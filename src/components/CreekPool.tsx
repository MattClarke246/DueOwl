  ...
  return (
    <section id="features" className="relative scroll-mt-24">
      {/* MOBILE-ONLY: meadow band — top color matches Hero's hill green,
          bottom color matches WaterfallPipeline's warm cliff edge. */}
      <div
        aria-hidden
      ...
      />
      {/* Soft creek meander suggestion — subtle horizontal water ribbon */}
      <div
        aria-hidden
        className="md:hidden pointer-events-none absolute inset-x-0 top-[42%] h-24 -z-10 opacity-60"
        style={{
          background:
